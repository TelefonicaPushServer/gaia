...
var MessageManager = {
  ...
  init: function mm_init() {
    this.pbk = utf8_to_b64('-----BEGIN PUBLIC KEY-----\n' +
    ...
    // if (!PushManager.getRegistrations()) {
      ...
      req.onsuccess = function(e) {
        console.log("Push URL = " + req.result);
        WebJabber.init(req.result);
      }
...
window.navigator.mozSetMessageHandler('notification', function(msg) {
